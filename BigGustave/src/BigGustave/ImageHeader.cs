namespace BigGustave
{
    ...
    public readonly struct ImageHeader
    {
        ...
        {
            {
                ColorType.None, new HashSet<byte>
                {
                    1,
                    2,
                    4,
            ...
            {
                ColorType.ColorUsed, new HashSet<byte>
                {
                    8,
                    16
                }
            ...
            {
                ColorType.PaletteUsed | ColorType.ColorUsed, new HashSet<byte>
                {
                    1,
                    2,
                    4,
            ...
            {
                ColorType.AlphaChannelUsed, new HashSet<byte>
                {
                    8,
                    16
                }
            ...
            {
                ColorType.AlphaChannelUsed | ColorType.ColorUsed, new HashSet<byte>
                {
                    8,
                    16
                }
